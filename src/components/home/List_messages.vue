...
<div 
    ...
    @click="
        ...
        store.chat_number  = chat_number;
        store.theme        = true;
        store.status       = true;
        store.last_message = true;
        store.dogovor      = true;
        store.login        = true;
        store.chat_name    = chat_manager;
        store.phone        = true;
        store.balance      = true;
        store.need_to_pay  = true;
        store.month_pay    = true;
        store.pay_day      = true;
        store.tarif        = true;
        store.tarif_prefix = true;
        store.day_speed    = true;
        store.nigth_speed  = true;
        store.app_version  = true;
        store.city_bk      = true;
        store.trash        = true;
    "
>
